...
<br><br><br>
  <a href="/" id="back-button"><img src="/back.png"></a>
  <div id="content">
    ...
    <br> 
    <p> ${el?.getAttribute("data-countyRegulationsDoc") === "" ? "No Regulation Document Available" : "<a href=\"" + el?.getAttribute("data-countyRegulationsDoc") + "\">Link to Regulations Document</a>"}
    <p> <a href="${el?.getAttribute("data-countyWebsite")}">Main County Website</a> </p>
